...
function WaterLevelCard({ points = fallbackPoints }) {
  ...
  return (
    <SectionCard subtitle="Past seven days from the active irrigation profile." title="Water level trend">
      <div className="water-level-card">
        <div className="water-level-card__summary">
          ...
          <span className="water-level-card__label">Current level</span>
        </div>

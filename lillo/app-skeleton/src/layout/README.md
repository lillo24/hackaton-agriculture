...
- After the network distribution step, `RoadmapPresentation` focuses the top farmer and reveals a small identikit burst (`sensor + crop + targeted-alert cue`) from that farmer before the cost overlay step.
